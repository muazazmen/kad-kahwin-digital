...
class UpdateDesignRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'bg_image' => 'nullable|file|mimes:png,webp|max:10240|dimensions:min_width=540,min_height=1080',
            'tentative_bg_image' => 'nullable|file|mimes:png,webp|max:10240|dimensions:min_width=540,min_height=1080',
        ];
    }
