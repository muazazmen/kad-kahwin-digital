        ...
        <div class="flex flex-col items-center justify-center">
            <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                    ...
                    <Form class="w-full" @submit.prevent="() => {authStore.authenticate('register', registerForm)}">
                        <label for="firstName" class="block text-surface-900 dark:text-surface-0 text-xl font-medium mb-2">First Name</label>
                        <InputText id="firstName" type="text" placeholder="First Name" class="w-full md:w-[30rem]" v-model="registerForm.first_name" />
                        <p v-if="authStore.errors.first_name" class="text-red-500">{{ authStore.errors.first_name[0] }}</p>
