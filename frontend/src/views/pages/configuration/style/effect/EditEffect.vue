...
<template>
    <div class="flex justify-between">
        ...
        <Button label="Back" icon="pi pi-arrow-left" @click="$router.push({ name: 'effect-list' })"
    ...
    <div class="grid grid-cols-1 md:grid-cols-12 gap-4 mt-4">
            ...
            <form @submit.prevent="submitForm">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
                    <div class="col-span-2">
                        ...
                        <InputText id="name" v-model="effectForm.name" placeholder="e.g. Particle Name"
                            :invalid="errors.name" fluid />
                ...
                <div class="flex justify-end mt-4 gap-4">
                    <Button label="Cancel" @click="$router.push({ name: 'effect-list' })"
        ...
        <div class="md:col-span-6 flex flex-col items-center gap-2 mb-8">
            ...
            <div class="relative bg-surface-50 dark:bg-surface-800 border border-gray-300 rounded-2xl w-[420px] h-[747px] overflow-hidden"
                    ...
                    <div :class="
                        ...
                        <div :class="
                            ...
                            <button type="button" @click="doorsOpen = true">
                                <div
                                    :class="`rounded-full w-32 h-32 flex flex-col items-center justify-center shadow-[0px_0px_15px_rgba(0,0,0,0.7)] pulse-animation bg-[#f2f2f2]`">
                ...
                <div class="relative flex flex-col justify-center items-center gap-4 w-full h-full">
                    ...
                    <div class="transition-opacity duration-1000 delay-700" :class="{ 'opacity-0': !doorsOpen }">
                        ...
                        <div v-if="particleOptions">
                            <vue-particles class="absolute inset-0 flex items-center justify-center w-full h-full"
