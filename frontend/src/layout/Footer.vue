...
<template>
    <div class="bg-surface-50 border-t dark:bg-surface-900">
        <div class="py-6 px-6 mx-0 my-12 lg:mx-20">
            <div class="grid grid-cols-12 gap-4">
                ...
                <div class="col-span-6 md:col-span-10">
                    <div class="flex justify-center">
                        <div class="grid grid-cols-12 max-w-6xl w-full mx-auto">
                            ...
                            <div class="col-span-4 md:col-span-4">
                                <h4 class="font-medium text-2xl leading-normal mb-4 text-surface-900 dark:text-surface-0">Polisi & Terma</h4>
                                <div class="flex flex-col gap-4">
                                    <span class="text-xl">Terma & Syarat</span>
                                    <span class="text-xl">Polisi Privasi</span>
                                    <span class="text-xl">Polisi Bayaran Balik</span>
                                </div>
                            </div>

                            <div class="col-span-4 md:col-span-4">
                                <h4 class="font-medium text-2xl leading-normal mb-4 text-surface-900 dark:text-surface-0">Ikuti Kami</h4>
                                <div class="flex">
                                    <i class="pi pi-instagram mr-4" style="font-size: 1.5rem;"></i>
                                    <i class="pi pi-twitter mr-4" style="font-size: 1.5rem;"></i>
                                    <i class="pi pi-facebook mr-4" style="font-size: 1.5rem;"></i>
                                </div>
                            </div>
                        </div>
                    </div>
