...
<template>
    <div class="bg-surface-50 border-t dark:bg-surface-900">
        <div class="py-6 px-6 mx-0 mt-12 lg:mx-20">
    ...
    <div class="layout-footer">
        <span class="font-semibold text-surface-700 dark:text-surface-200">Hak Cipta Terpelihara &copy; {{ now }} {{ appName }}</span>
    </div>
</template>
